...
export default async function ManageIbPage() {
  ...
  return (
    <main style={{ maxWidth: 1200, margin: "2rem auto", fontFamily: "sans-serif", padding: "0 1rem" }}>
      <h1>Introducing Brokers</h1>
      <p style={{ color: "#666" }}>
        {rows.length} relationship{rows.length === 1 ? "" : "s"}. Pending commission is calculated from
        each client&apos;s closed trades since the last payout.
      </p>
