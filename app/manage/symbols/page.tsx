...
export default async function ManagerSymbolsPage() {
  ...
  return (
    <main style={{ maxWidth: 1400, margin: "2rem auto", fontFamily: "sans-serif", padding: "0 1rem" }}>
      <h1>Symbols</h1>
      <p style={{ color: "#666" }}>
        Spread markup, lot limits, swap, and commission per symbol for this broker. A symbol with no
        saved row yet shows the platform default — saving it creates the row.
      </p>
