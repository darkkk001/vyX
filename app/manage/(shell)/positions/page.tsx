...
//
// Deliberately no dealer-activity feed here (2026-09-04 refinement) --
// this page stays focused on exposure/P&L; the dealer's own activity feed
// + resting-orders panel live only on the Dealing page's Activity tab
// (components/admin/DealingDeskPanel.tsx), where the dealer actually
// works.
