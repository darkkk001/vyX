...
pub fn apply_spread_markup(raw: &Tick, spread_markup: Decimal, digits: i32) -> Tick {
    ...
    Tick {
        ...
        t0: raw.t0,
        clock_offset_ms: raw.clock_offset_ms,
        rtt_ms: raw.rtt_ms,
        tick_ms: raw.tick_ms,
        broker_offset_sec: raw.broker_offset_sec,
        bars: raw.bars.clone(),
    }
}
...
mod tests {
    ...
    fn tick() -> Tick {
        Tick { symbol: "EURUSD".into(), bid: dec!(1.10000), ask: dec!(1.10020), t0: None, clock_offset_ms: None, rtt_ms: None, tick_ms: None, broker_offset_sec: None, bars: Vec::new() }
    }
    ...
    fn three_digit_symbol_uses_a_larger_pip() {
        ...
        let jpy_tick = Tick { symbol: "USDJPY".into(), bid: dec!(150.000), ask: dec!(150.020), t0: None, clock_offset_ms: None, rtt_ms: None, tick_ms: None, broker_offset_sec: None, bars: Vec::new() };
